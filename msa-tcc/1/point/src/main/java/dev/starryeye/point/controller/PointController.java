...
import dev.starryeye.point.controller.request.ReservedPointCancelRequest;
...
public class PointController {
    ...
    public void cancel(@RequestBody ReservedPointCancelRequest request) {
        ...
        try {
            pointService.cancelReserve(request.toCommand());
        } finally {
            lock.unlock("point_reservation:", request.reservationId());
        }
    }
